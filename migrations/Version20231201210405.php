 ...
 */
final class Version20231201210405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pop (id INT AUTO_INCREMENT NOT NULL, serie_id INT NOT NULL, name VARCHAR(255) NOT NULL, number INT NOT NULL, search LONGTEXT DEFAULT NULL, INDEX IDX_19D0B716D94388BD (serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
